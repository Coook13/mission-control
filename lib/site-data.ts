...
export const faces: Record<FaceId, FaceContent> = {
  engineering: {
    ...
    color: "#2457E6",
    thesis: "I build the technical side myself, from vision models to robot arm control.",
    proofs: [
  ...
  strategy: {
    ...
    color: "#F2C94C",
    thesis: "I check whether the numbers behind a plan hold up before anyone commits to it.",
    proofs: [
  ...
  finance: {
    ...
    color: "#2F9E5B",
    thesis: "I value companies and take positions with real money behind them.",
    proofs: [
  ...
  research: {
    ...
    color: "#F28A2E",
    thesis: "I like problems where nobody has the answer yet.",
    proofs: [
...
export const projects: Project[] = [
  {
    ...
    action: "I co-founded the venture, interviewed 20+ engineers and students, mapped the workflow bottlenecks, and used that evidence to define the first product scope, feature priorities, and pricing direction.",
  ...
  },
  {
    ...
    oneLine: "A CNN for solar-panel defect detection, built during an ML internship at QuantGates.",
    ...
    action: "At QuantGates I built and benchmarked a convolutional neural network for solar-panel hotspot detection, then adapted it to run on drone footage in place of manual thermal checks. I also worked on an exploratory in-house language model.",
  ...
  },
  {
    ...
    action: "We valued Prysmian with a DCF, trading comps, Monte Carlo simulation, and regression forecasting, and let the disagreement between the methods set the range. We anchored the terminal value to nominal GDP rather than an exit multiple.",
  ...
  },
  {
    ...
    oneLine: "A venture-capital internship on an early-stage health-tech team in Bangkok.",
    problem: "Early-stage investing rewards judgement about markets and founders before the numbers are clean.",
    action: "I work with the investment team on sourcing, diligence, and market work across early-stage health-tech in Southeast Asia.",
    result: "Running from July to September 2026, taken as a warm route toward strategy and investing roles in the region.",
  ...
  },
  {
    ...
    oneLine: "Self-directed systematic trading, built and tested under a hard drawdown limit.",
    ...
    result: "I run systematic strategies through an FTMO-funded account at a 1.6 live Sharpe within a 10% maximum-drawdown limit. I keep this as a personal discipline rather than a headline.",
    meta: { role: "Self-directed", period: "2024 to present", place: "Remote", outcome: "FTMO-funded, 1.6 live Sharpe" },
  ...
  },
  {
    ...
    action: "I led a 12-person business and marketing function inside a 60-person company, building the electrical systems and the financial model that kept the settlement profitable.",
    result: "The team placed as a global runner-up at the NASA-sponsored ISSDC final at Kennedy Space Center.",
