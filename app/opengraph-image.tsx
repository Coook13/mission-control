...
export default function OpengraphImage() {
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", background: "#F5F6F7", color: "#121212", padding: "70px 78px", fontFamily: "Arial, sans-serif", position: "relative" }}>
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", width: "58%" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <strong style={{ fontSize: 72, lineHeight: 1.02, letterSpacing: "-0.02em" }}>Engineer, founder,<br />strategist, investor.</strong>
          <span style={{ marginTop: 28, fontSize: 21 }}>Manchester / Bangkok</span>
        </div>
      </div>
      <div style={{ position: "absolute", right: 92, top: 90, width: 410, height: 410, display: "flex", flexWrap: "wrap", transform: "rotate(-9deg)", boxShadow: "20px 30px 55px rgba(18,18,18,0.18)", background: "#121212", padding: 14 }}>
